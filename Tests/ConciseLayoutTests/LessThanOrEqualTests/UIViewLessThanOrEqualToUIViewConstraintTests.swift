    ...
    func testEdgesConstraints() {
        XCTContext.runActivity(named: "lessThanOrEqual(to another:)") { _ in
            ...
            let expectedConstraints = [
                ...
                subview.rightAnchor.constraint(lessThanOrEqualTo: superview.rightAnchor),
        ...
        XCTContext.runActivity(named: "lessThanOrEqualToSuperview(inside:)") { _ in
            XCTContext.runActivity(named: "inside insets: UIEdgeInsets") { _ in
                ...
                let expectedConstraints = [
                    subview.topAnchor.constraint(lessThanOrEqualTo: superview.topAnchor, constant: 10),
                    subview.leftAnchor.constraint(lessThanOrEqualTo: superview.leftAnchor, constant: 20),
                    subview.rightAnchor.constraint(lessThanOrEqualTo: superview.rightAnchor, constant: -40),
                    subview.bottomAnchor.constraint(lessThanOrEqualTo: superview.bottomAnchor, constant: -30)
                ]
                NSLayoutConstraint.activate(expectedConstraints)
                assertEqual(constraints, expectedConstraints)
            }
            XCTContext.runActivity(named: "inside inset: CGFloat") { _ in
                ...
                let expectedConstraints = [
                    ...
                    subview.leftAnchor.constraint(lessThanOrEqualTo: superview.leftAnchor, constant: 20),
                    subview.rightAnchor.constraint(lessThanOrEqualTo: superview.rightAnchor, constant: -20),
